...
export const siteConfig: SiteConfig = {
	title: "彼方の部屋",
	subtitle: "名侦探彼方的个人博客",
	siteURL: "https://himukai-kanata.github.io/Mizuki/", // 请替换为你的站点URL，以斜杠结尾
	...
	anime: {
		...
		localData: [] // 本地番剧数据，当 mode 为 "local" 时使用
	},
	...
	toc: {
		...
		useJapaneseBadge: true, // 使用日语假名标记（あいうえお...）代替数字，开启后将 1、2、3... 改为 あ、い、う...
	},
...
export const expressiveCodeConfig: ExpressiveCodeConfig = {
	// 注意：某些样式（如背景颜色）已被覆盖，请查阅 astro.config.mjs 文件。
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到彼方的房间～这里记录着我和主人的故事！", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Kanata's Room!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
